...
struct CompMockData {
    ...
    private let vegan: ListSection = {
        .vegan([
            .init(title: "Vegan 1", image: "https://spoonacular.com/recipeImages/715521-312x231.jpg", id: 1),
    ...
    private let random: ListSection = {
        .random([
            .init(title: "Popular 1", image: "https://spoonacular.com/recipeImages/715415-312x231.jpg", id: 1),
